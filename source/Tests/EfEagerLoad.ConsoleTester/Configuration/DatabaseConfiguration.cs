...
namespace EfEagerLoad.ConsoleTester.Configuration
{
    public static class DatabaseConfiguration
    {
        ...
        public static async Task SetupDatabase<TDbContext>(this IServiceProvider serviceProvider, bool createDataBase = false, bool recreateDataBase = false,
                                                            bool runMigrations = false) where TDbContext : DbContext
        {
            using (var scope = serviceProvider.CreateScope())
            {
                ...
                if (recreateDataBase)
                {
                    await DeleteDatabase(dbContext);
                }
        ...
        public static async Task SetupDataInDatabase(this IServiceProvider serviceProvider)
        {
            using (var scope = serviceProvider.CreateScope())
            {
        ...
        private static async Task DeleteDatabase(DbContext dbContext)
        {
